...
| Policy engine | Matching core implemented | Bounded YAML/JSON, atomic A/B generation updates, and file/exec/network match evidence exist; live map activation and kernel enforcement are pending. |
